...
export const Footer = () => {
  const navigation = [
    {
      name: "GitHub",
      href: "https://github.com/G1anpierre",
      icon: (props: any) => (
        <svg
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/gianpierre-fernandez-ba3a7916b/",
      icon: (props: any) => (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    <footer className={styles.container}>
      <div className={styles.layout}>
        ...
        <p className={styles.author}>
          © Washazon 2024 by Gianpierre Fernandez, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  );
